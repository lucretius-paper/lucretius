...
JNIEXPORT jint JNICALL Java_lucretius_Rapl_ProfileInit(JNIEnv *env, jclass jcls) {
	jintArray result;
	int i;
...
JNIEXPORT jint JNICALL Java_lucretius_Rapl_GetSocketNum(JNIEnv *env, jclass jcls) {
...
JNIEXPORT jstring JNICALL Java_lucretius_Rapl_EnergyStatCheck(JNIEnv *env,
		jclass jcls) {
	jstring ener_string;
